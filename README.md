...
The site header includes a keyboard-accessible high-contrast mode toggle. The preference is stored in the browser and restored across page reloads so users can keep stronger contrast while browsing.
